...
import ButtonFlotting from '../Components/FloatingButton';
...
const HomeScreen = ({ navigation }) => {
  return (
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.logoutButton} onPress={() => navigation.navigate('InfoAccount')}>
          <FontAwesome name="user-circle" size={40} color="#0370B7" />
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.CardClinic}>
        <MaterialIcons name="favorite" size={40} color="#60F4A0" />
        <View style={styles.CardDescription}>
          <Text style={{fontWeight: 600, color: '#fff', fontSize: 15, paddingVertical: 2}}>Clinic visit</Text>
          <Text style={{color: '#fff', fontWeight: 300}}>Make appointment</Text>
        </View>
      </View>
      </View>
